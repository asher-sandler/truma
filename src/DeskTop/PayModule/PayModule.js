...
class PayModule extends Component {
    ...
    validate = () => {
        ...
        let arrowPanel = document.getElementsByName("down-arrow-panel-desktop")[0];
        if (validated) {
            // alert alert-success
            ...
            arrowPanel.className="down-arrow-panel-desktop-show";
            this.setState({formValidated: true})
        } else {
            vmessage.className = "alert alert-danger";
            vmessage.textContent = "בבקשה מלא את הטופס!";
            arrowPanel.className="down-arrow-panel-desktop-hide";
                                ...
                                <div className="row">
                                    <div className="col-md-10 mx-auto">
                                        ...
                                        <div className="hidden-mobile" id="hidden-box">
                                            ...
                                            <div className="down-arrow-panel-desktop-hide" name="down-arrow-panel-desktop">
                                                <img src="/img/beit-habad/arrow-down.png" className="down-arrow" alt="down-arrow"/>
                                            </div>
                                        </div>
